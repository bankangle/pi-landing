...
export const dict = {
	ru: {
		...
		contact: {
			...
			orEmail: 'на почту',
			orLeave: 'или оставьте свой контакт — мы свяжемся сами',
			name: 'Имя',
			namePh: 'Как к вам обращаться',
			email: 'Телефон или почта',
			emailPh: 'Почта или номер телефона',
			badContact: 'Похоже, это не телефон и не почта. Проверьте, пожалуйста.',
			message: 'Сообщение',
			messagePh: 'Пара слов о задаче…',
			submit: 'Отправить',
			sending: 'Отправляем…',
			success: 'Мы получили заявку и скоро свяжемся.',
	...
	en: {
		...
		contact: {
			...
			orEmail: 'email us at',
			orLeave: 'or leave your contact — we will reach out',
			name: 'Name',
			namePh: 'What should we call you',
			email: 'Phone or email',
			emailPh: 'Email or phone number',
			badContact: 'That does not look like a phone number or an email. Please check it.',
			message: 'Message',
			messagePh: 'A few words about the task…',
			submit: 'Send',
			sending: 'Sending…',
			success: 'We got your request and will be in touch shortly.',
